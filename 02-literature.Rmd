...
photo_credit(person="Hugh Thompson", description="Peacock cover", explanation="Found on the web.", url="")
```
...
photo_credit(person="Public domain", description="Rag Doll and Broom Handle",
