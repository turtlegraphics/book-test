...
# Literature
Some text and exercises, and a demonstration vignette.  The text is from Sandburg^[@rootabaga].
...
Or if you want something a little longer, read *Pride and Prejudice*^[@pnp] or *Emma*, in the `austen`\indexfosdata{austen}
data set from the `fosdata` package.

```{r peacock, echo=FALSE, out.width="30%", fig.align="center", fig.cap="Pride and Prejudice book cover."}
knitr::include_graphics("images/pnp_peacock.jpg")
photo_credit(person="Hugh Thompson", description="Peacock cover", explanation="Found on the web.", url="", figure="peacock")
```
...
photo_credit(person="Maud and Miska Petersham", description="Rag Doll and Broom Handle",
             explanation="This work is in the public domain in the United States because it was published (or registered with the U.S. Copyright Office) before January 1, 1926.",
             url="https://commons.wikimedia.org/wiki/File:Rootabaga_Stories_-_Story_4_Headpiece.png")
```
