...
::: theorem
Using fenced divs is superior to the bookdown approach.
:::

::: proof
We do not like the bookdown approach using code blocks because it ruins the syntax highlighting in RStudio, cannot be nested or contain R code, and
